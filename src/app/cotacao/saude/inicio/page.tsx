...
import { Shield, MessageCircle, FileText, ArrowLeft, User, LogOut, Zap, Clock, Bot, Users, Star, Heart } from 'lucide-react'

export default function InicioSaudePage() {
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <div className="ml-4 px-3 py-1 bg-red-100 rounded-full">
              <span className="text-red-600 text-sm font-medium font-inter">Seguro Saúde</span>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#656D7A] mb-8 font-inter max-w-2xl mx-auto">
            Cuidados médicos quando você mais precisa. Escolha como prefere fazer sua cotação:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          {/* Chatbot Option */}
          <div 
            onClick={() => router.push('/cotacao/saude/chatbot')}
          ...
          >
            ...
            <p className="text-[#656D7A] leading-relaxed mb-6 font-inter">
              Conversa natural sobre suas necessidades de saúde. Respostas simples para encontrar o plano ideal.
            </p>
          ...
          <div 
            onClick={() => router.push('/cotacao/saude/formulario')}
          ...
          >
            ...
            <p className="text-[#656D7A] leading-relaxed mb-6 font-inter">
              Preencha um formulário estruturado com suas informações de saúde e preferências.
            </p>
            ...
            <div className="space-y-3 mb-8">
              ...
              <div className="flex items-center space-x-3">
                <Clock className="w-5 h-5 text-[#00BA88]" />
                <span className="text-sm text-[#656D7A] font-inter">4-6 minutos</span>
              </div>
            </div>
        ...
        {/* Informações Específicas para Saúde */}
        <div className="bg-white rounded-2xl border border-[#E9EDF2] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <h4 className="font-medium text-[#1D2129] font-inter">Informações Básicas:</h4>
              <ul className="text-sm text-[#656D7A] space-y-1 font-inter">
                <li>• Idade e sexo</li>
                <li>• CEP de residência</li>
                <li>• Renda familiar aproximada</li>
                <li>• Número de dependentes</li>
              </ul>
            </div>
            <div className="space-y-2">
              <h4 className="font-medium text-[#1D2129] font-inter">Histórico de Saúde:</h4>
              <ul className="text-sm text-[#656D7A] space-y-1 font-inter">
                <li>• Doenças preexistentes (se houver)</li>
                <li>• Medicamentos de uso contínuo</li>
                <li>• Cirurgias realizadas</li>
                <li>• Preferências de hospitais</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-[#F0F8FF] border border-[#87CEEB] rounded-lg">
            <p className="text-sm text-[#2C5282] font-inter">
              💡 <strong>Dica:</strong> Seja honesto sobre seu histórico de saúde. Isso garante que você 
              tenha acesso aos tratamentos quando precisar, evitando problemas futuros com reembolsos.
            </p>
          </div>
        </div>
      </div>
