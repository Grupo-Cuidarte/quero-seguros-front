...
import { MessageCircle, ArrowLeft, Shield, MapPin, Loader2, Heart } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-900">Plano de Saúde</span>
            </div>
                  ...
                  >
                    {step.type === 'bot' && (
                      <div className="flex items-center mb-2">
                        ...
                        <span className="text-xs font-medium text-red-600">Assistente Saúde</span>
                      </div>
                    )}
                ...
                <div className="grid grid-cols-1 gap-3 max-h-80 overflow-y-auto">
                  {currentStep.options?.map((option) => (
                    <button
                      ...
                      className="flex items-center justify-center px-4 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-colors"
                    >
                      {option.label}
                    </button>
                  ))}
              ...
              {currentStep?.type === 'input' && (
                <div className="flex space-x-3">
                  ...
                  <button
                    ...
                    className="px-6 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Enviar
                  </button>
                </div>
              ...
              {currentStep?.type === 'consent' && (
                <div className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
