...
export default function InicioVidaPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <div className="ml-4 px-3 py-1 bg-green-100 rounded-full">
              <span className="text-green-600 text-sm font-medium font-inter">Seguro Vida</span>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-[#656D7A] mb-8 font-inter max-w-2xl mx-auto">
            Segurança financeira para sua família em todos os momentos. Escolha como prefere fazer sua cotação:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          {/* Chatbot Option */}
          <div 
            onClick={() => router.push('/cotacao/vida/chatbot')}
          ...
          >
            ...
            <p className="text-[#656D7A] leading-relaxed mb-6 font-inter">
              Conversa natural sobre suas necessidades de proteção familiar. Respostas simples para encontrar a cobertura ideal.
            </p>
          ...
          <div 
            onClick={() => router.push('/cotacao/vida/formulario')}
          ...
          >
            ...
            <p className="text-[#656D7A] leading-relaxed mb-6 font-inter">
              Preencha um formulário estruturado com suas informações pessoais e familiares.
            </p>
        ...
        {/* Informações Específicas para Vida */}
        <div className="bg-white rounded-2xl border border-[#E9EDF2] p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-[#1D2129] font-inter">Cobertura Desejada:</h4>
              <ul className="text-sm text-[#656D7A] space-y-1 font-inter">
                <li>• Valor de cobertura pretendido</li>
                <li>• Beneficiários</li>
                <li>• Histórico de saúde básico</li>
                <li>• Atividades de risco (se houver)</li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-6 p-4 bg-[#F0F8FF] border border-[#87CEEB] rounded-lg">
            <p className="text-sm text-[#2C5282] font-inter">
              💡 <strong>Dica:</strong> O seguro vida é essencial para proteger sua família financeiramente. 
              Calcule uma cobertura de 5 a 10 vezes sua renda anual para garantir tranquilidade total.
            </p>
          </div>
        </div>
      </div>
